...
/**
 * PDF417 error correction code following the algorithm described in ISO/IEC
 * 15438:2001(E) in chapter 4.10.
 */
final class PDF417ErrorCorrection {

	/**
	 * Tables of coefficients for calculating error correction words (see annex
	 * F, ISO/IEC 15438:2001(E))
	 */
	...
	/**
	 * Determines the number of error correction codewords for a specified error
	 * correction level.
	 * 
	...
	/**
	 * Returns the recommended minimum error correction level as described in
	 * annex E of ISO/IEC 15438:2001(E).
	 * 
	 * @param n
	...
	/**
	 * Generates the error correction codewords according to 4.10 in ISO/IEC
	 * 15438:2001(E).
	 * 
	 * @param dataCodewords
	 *            the data codewords
	 ...
	 */
	static String generateErrorCorrection(CharSequence dataCodewords,
