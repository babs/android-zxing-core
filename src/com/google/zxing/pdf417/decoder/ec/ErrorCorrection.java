...
public final class ErrorCorrection {
	...
	public int decode(int[] received, int numECCodewords, int[] erasures)
		...
		ModulusPoly[] sigmaOmega = runEuclideanAlgorithm(
	...
	private ModulusPoly[] runEuclideanAlgorithm(ModulusPoly a, ModulusPoly b,
			int R) throws ChecksumException {
	...
	private int[] findErrorMagnitudes(ModulusPoly errorEvaluator,
			ModulusPoly errorLocator, int[] errorLocations) {
		...
		ModulusPoly formalDerivative = new ModulusPoly(field,
