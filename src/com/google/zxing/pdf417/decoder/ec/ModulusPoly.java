...
final class ModulusPoly {
	...
	ModulusPoly add(ModulusPoly other) {
		...
		for (int i = lengthDiff; i < largerCoefficients.length; i++) {
			sumDiff[i] = field.add(smallerCoefficients[i - lengthDiff],
	...
	ModulusPoly[] divide(ModulusPoly other) {
		...
		while (remainder.getDegree() >= other.getDegree()
			...
			ModulusPoly term = other
					.multiplyByMonomial(degreeDifference, scale);
			ModulusPoly iterationQuotient = field.buildMonomial(
