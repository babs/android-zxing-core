 ...
 * right and below the barcode's {@link ResultPoint}s are scanned, recursively.
 * </p>
 * 
 * <p>
...
public final class GenericMultipleBarcodeReader implements
	...
	private void doDecodeMultiple(BinaryBitmap image,
			Map<DecodeHintType, ?> hints, List<Result> results, int xOffset,
			int yOffset, int currentDepth) {
	...
	private static Result translateResultPoints(Result result, int xOffset,
		...
		Result newResult = new Result(result.getText(), result.getRawBytes(),
