	...
	public ExpandedProductParsedResult parse(Result result) {
		...
		while (i < rawText.length()) {
			...
			switch (iai) {
				...
				case 3933:
					if (value.length() < 4) {
						// The value must have more of 3 symbols (3 for currency
						// and
						// 1 at least for the price)
						// ExtendedProductParsedResult NOT created. Not match
						// with RSS Expanded pattern
						return null;
					}
